...
function createHome(){
    ...
    // const fillerTwo= createElementFunction('p' ,`Bring your beloved, immerse yourselves in the ambiance, and let the evening unfold with a sense of elegance, warmth, and timeless allure. Because for us, romance isn’t just a feeling—it’s an experience to be savored, together.`, 'filler-text');
